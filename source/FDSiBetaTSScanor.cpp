/** FDSiBetaTSScanor.cpp generated by R. Yokoyama 10/06/2020 **/
#include "FDSiBetaTSScanor.hpp"

const std::string FDSiBetaTSScanor::kMsgPrefix("[FDSiBetaTSScanor]:");

void FDSiBetaTSScanor::SetReader()
{
...
Bool_t FDSiBetaTSScanor::IsInGate()
{
