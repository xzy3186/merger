// AnamergerYSOSelector.cpp created by Rin Yokoyama on 2/1/2019

#include "AnamergerYSOSelector.h"
#include <iostream>
#include <fstream>
#include <string>

ClassImp(AnamergerYSOSelector);
  
AnamergerYSOSelector::AnamergerYSOSelector(TTree* mergedData):
   aReader (mergedData),
...
AnamergerYSOSelector::~AnamergerYSOSelector()
{

}

void AnamergerYSOSelector::Begin(TTree* mergedData)
{
  GetOutputList()->Clear();
}

void AnamergerYSOSelector::SlaveBegin(TTree* mergedData)
{
...
void AnamergerYSOSelector::Init(TTree* mergedData)
{    
...
Bool_t AnamergerYSOSelector::Process(Long64_t entry){
...
void AnamergerYSOSelector::Terminate(){
  ...
  {
    sting parString("Beta-F11 time cut window. Long_t DTfblow= ");
...
int AnamergerYSOSelector::loadCUTG(std::string icutname)
{
